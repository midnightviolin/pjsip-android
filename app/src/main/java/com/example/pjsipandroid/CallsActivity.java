...
import static com.example.pjsipandroid.ServiceCommunicator.apiHasRetrievedNumbers;
import static com.example.pjsipandroid.ServiceCommunicator.arraySpinner;
import static com.example.pjsipandroid.ServiceCommunicator.callID1;
import static com.example.pjsipandroid.ServiceCommunicator.callID2;
import static com.example.pjsipandroid.ServiceCommunicator.callIsActive;
import static com.example.pjsipandroid.ServiceCommunicator.hostname;
import static com.example.pjsipandroid.ServiceCommunicator.itemList;
import static com.example.pjsipandroid.ServiceCommunicator.transferList;
import static com.example.pjsipandroid.ServiceCommunicator.uri;
...
import com.example.pjsipandroid.Pojo.ChildItem;
import com.example.pjsipandroid.Pojo.TransferData;
import com.example.pjsipandroid.adapters.ParentItemAdapter;
import com.example.pjsipandroid.adapters.TransferRecyclerViewAdapter;
...
//    }
    ...
    public void answer(View view) {
            ...
            if (hangup.getVisibility() == View.GONE) {
                call();
                    ...
                    SipServiceCommand.acceptIncomingCall(this, uri, callID1, isVideo);
                }
    }
    ...
    private void makeAttendedCallTransfer(){
        if (!isHold) {
            ...
            hold.setBackgroundTintList(ColorStateList.valueOf(this.getResources().getColor(androidx.cardview.R.color.cardview_dark_background)));
